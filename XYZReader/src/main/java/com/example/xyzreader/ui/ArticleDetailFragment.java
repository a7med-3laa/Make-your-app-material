...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardView = mRootView.findViewById(R.id.cardView);
        toolbar = mRootView.findViewById(R.id.anim_toolbar);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            getActivity().navigateUpTo(new Intent(getActivityCast(), ArticleListActivity.class));
            return true;
        }
...
//                   cardView.setCardBackgroundColor(darkMutedColor);
                mRootView.findViewById(R.id.frameLayout).setBackgroundColor(darkMutedColor);
